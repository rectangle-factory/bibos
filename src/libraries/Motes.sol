...
library Motes {
    ...
    function render(bytes32 _seed) internal pure returns (string memory) {
        ...
        for (uint8 index = 0; index < moteCount; index++) {
            ...
            result = addMote(result, durationLong, "10", coords[index], mixMode, "white", reverseRotate, reverse, opacity);
        }
    ...
    function addMote(
        ...
        return
            string.concat(
                ...
                ') scale(1)">',
                "<g>",
                SVG.circleFilter(_radius, ["0", "0"], _mixMode, _fill, "1.0", "bibo-blur-sm"),
                "</circle>",
                "<path fill-opacity=",
                Util.quote(_opacity),
                ...
                "</path>",
                //
                // lines below is causing me trouble
                // //
