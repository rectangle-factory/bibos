...
library Traits {
    ...
    function eyeType(bytes32 _seed) internal pure returns (EyeType) {
        ...
        if (eyeRarity % 100 < 20) return EyeType.OVAL;
        if (eyeRarity % 100 < 40) return EyeType.ROUND;
        if (eyeRarity % 100 < 50) return EyeType.SMILEY;
        if (eyeRarity % 100 < 60) return EyeType.SLEEPY;
        if (eyeRarity % 100 < 70) return EyeType.WINK;
        if (eyeRarity % 100 < 80) return EyeType.HAHA;
        if (eyeRarity % 100 < 84) return EyeType.CLOVER;
        if (eyeRarity % 100 < 88) return EyeType.STAR;
        if (eyeRarity % 100 < 92) return EyeType.DIZZY;
        if (eyeRarity % 100 < 96) return EyeType.HEART;
        if (eyeRarity % 100 < 99) return EyeType.CYCLOPS;
    ...
    function mouthType(bytes32 _seed) internal pure returns (MouthType) {
        ...
        if (mouthRarity % 100 < 20) return MouthType.SMILE;
        if (mouthRarity % 100 < 40) return MouthType.GRATIFIED;
        if (mouthRarity % 100 < 60) return MouthType.POLITE;
        if (mouthRarity % 100 < 70) return MouthType.GRIN;
        if (mouthRarity % 100 < 80) return MouthType.SMIRK;
        if (mouthRarity % 100 < 89) return MouthType.VEE;
        if (mouthRarity % 100 < 92) return MouthType.OOO;
        if (mouthRarity % 100 < 94) return MouthType.HMM;
        if (mouthRarity % 100 < 95) return MouthType.TOOTHY;
        if (mouthRarity % 100 < 97) return MouthType.BLEP;
        if (mouthRarity % 100 < 98) return MouthType.SMOOCH;
