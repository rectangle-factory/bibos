...
=======
    function body(bytes1 value) internal pure returns (string[2] memory) {
        string[2][64] memory bodyPoints = [
            ["186", "165"],
            ["170", "119"],
            ["174", "150"],
        ...
        return bodyPoints[uint8(value) % 64];
    }

    function glint(bytes1 value) internal pure returns (string[2] memory) {
>>>>>>> main
...
=======
        return glintPoints[uint8(value) % 64];
>>>>>>> main
    }
}
