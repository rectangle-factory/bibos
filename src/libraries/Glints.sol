    ...
    function addGlint(
        ...
        return
            string.concat(
                ...
                '<animateTransform calcMode="spline" keyTimes="0; 0.5; 1" keySplines="0.4 0 0.4 1; 0.4 0 0.4 1" values="1; 1.25; 1" attributeName="transform" attributeType="XML" type="scale" additive="sum" begin=',
                Util.quote(_durationShorter),
