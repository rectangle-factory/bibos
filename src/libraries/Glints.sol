    ...
    function addGlint(
        ...
        return
            string.concat(
                ...
                '<animateTransform calcMode="spline" keyTimes="0; 0.5; 1" keySplines="0.4 0 0.4 1; 0.4 0 0.4 1" values="0.85; 1.25; 0.85" attributeName="transform" attributeType="XML" type="scale" additive="sum" beg="0s" dur="1.5s"  repeatCount="indefinite" />',
                "</path>",
